...
#include "../../Project5/aboutdialog.h"
...
QT_MOC_LITERAL(1, 12, 5), // "about"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 12) // "closeClicked"

    },
    "AboutDialog\0about\0\0closeClicked"
};
...
void AboutDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AboutDialog::about)) {
                *result = 0;
                return;
            }
        }
